...
export const enUS: Translations = {
  ...
  welcome: {
    ...
    description:
      "Welcome to AI Teacher Copilot, an education-focused AI assistant for reviewing assignments, understanding class learning, and planning next steps.",

    createYourOwnSkill: "Create Your Own Skill",
    createYourOwnSkillDescription:
      "Create your own skill to extend AI Teacher Copilot. With customized skills,\nAI Teacher Copilot can help you review assignments, analyze learning data, and\nprepare practical teaching suggestions.",
  },
  ...
  inputBox: {
    ...
    voiceInputStart:
      "Dictate with voice. AI Teacher Copilot receives only transcribed text; audio is handled by your browser or system speech service.",
  ...
  backgroundTasks: {
    ...
    cancellationRetrying: (attempt) =>
      `Cancellation attempt ${attempt} failed; the system will keep retrying.`,
    notificationRetrying: (attempt) =>
      `Chat notification attempt ${attempt} failed; the system will retry with backoff.`,
    notificationStopped:
      "Chat notification delivery stopped after repeated or permanent failures.",
    trackingDegraded:
      "Status checks are delayed; the system is still retrying.",
  ...
  scheduledTasks: {
    ...
    context: {
      ...
      reuseNoticeDescription:
        "If this thread has an active run at the scheduled time, the system queues this occurrence and starts it when the thread is available. It fails if the configured queue wait limit is exceeded.",
    },
    filters: {
  ...
  // Workspace
  workspace: {
    officialWebsite: "AI Teacher Copilot project site",
    githubTooltip: "AI Teacher Copilot on GitHub",
    settingsAndMore: "Settings and more",
    visitGithub: "AI Teacher Copilot on GitHub",
    reportIssue: "Report an issue",
    contactUs: "Contact us",
    about: "About AI Teacher Copilot",
    logout: "Log out",
  ...
  channels: {
    ...
    descriptions: {
      buzz: "Buzz channels and direct messages through your AI Teacher Copilot agent.",
      telegram: "Telegram direct messages through your AI Teacher Copilot bot.",
      slack: "Slack workspace messages and mentions.",
      discord: "Discord server messages through your AI Teacher Copilot bot.",
      feishu: "Feishu and Lark messages through your AI Teacher Copilot app.",
      dingtalk:
        "DingTalk Stream Push messages through your AI Teacher Copilot bot.",
      wechat: "WeChat iLink messages through your AI Teacher Copilot bot.",
      wecom: "WeCom messages through your AI Teacher Copilot bot.",
    },
  ...
  toolCalls: {
    ...
    skillInstallTooltip:
      "Install skill and make it available to AI Teacher Copilot",
  ...
  shortcuts: {
    ...
    keyboardShortcutsDescription:
      "Navigate AI Teacher Copilot faster with keyboard shortcuts.",
  ...
  settings: {
    ...
    memory: {
      title: "Memory",
      description:
        "AI Teacher Copilot automatically learns from your conversations in the background. These memories help it understand you better and deliver a more personalized experience.",
    ...
    channels: {
      title: "Channels",
      description:
        "Connect IM accounts that can send messages to AI Teacher Copilot from outside the browser.",
      disabled:
    ...
    integrations: {
      ...
      lark: {
        ...
        changeAppDescription:
          "Point your AI Teacher Copilot account at a different Lark/Feishu app. This only affects your account; other users are not changed.",
        ...
        authStarted:
          "Authorization page opened. AI Teacher Copilot will detect completion automatically.",
        authorizationStillPending:
          'Authorization is not complete yet. Finish it in the browser; AI Teacher Copilot keeps checking automatically. You can click "I completed authorization" if the page does not update.',
        permissionTitle: "Authorization scope",
        permissionDescription:
          "By default, AI Teacher Copilot only completes the base sign-in and does not request any business permissions. Select the domains you need here; connected users can re-authorize to add more (scopes accumulate).",
        authDomains: {
          calendar: {
            label: "Calendar",
            description:
        ...
        openAuthLinkDescription:
          "Open the link below to authorize. AI Teacher Copilot keeps checking automatically and will save the connection after approval.",
        waitingAuthTitle: "Waiting for Lark authorization",
        waitingAuthDescription:
          "Finish authorization in the browser page that just opened. AI Teacher Copilot will update this panel automatically; the button below is only a fallback.",
        ...
        authNextDescription:
          "Click “Connect Lark”; AI Teacher Copilot checks the current status first and opens browser authorization only when disconnected or expired.",
      },
    },
    skills: {
      title: "Agent Skills",
      ...
      emptyDescription:
        "Put your agent skill folders under the `/skills/custom` folder under the project root.",
    ...
    notification: {
      title: "Notification",
      description:
        "AI Teacher Copilot only sends a completion notification when the window is not active. This is especially useful for long-running tasks so you can switch to other work and get notified when done.",
      requestPermission: "Request notification permission",
      deniedHint:
        "Notification permission was denied. You can enable it in your browser's site settings to receive completion alerts.",
      testButton: "Send test notification",
      testTitle: "AI Teacher Copilot",
    ...
    account: {
      ...
      ssoPasswordMessage:
        "This account signs in with {provider}, so AI Teacher Copilot cannot manage or change its password here. Use your SSO provider's account settings instead.",
  ...
  login: {
    ...
    rememberMeDescription:
      "Keep this browser session when possible. The system stores only your email, never your password.",
