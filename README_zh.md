...
> 本项目基于成熟的开源 Agent（智能体）运行时能力构建，保留稳定的对话、工具、技能、记忆、沙箱和流式执行机制，以支持后续维护与升级。
...
- Teacher Copilot：通过自然语言查询真实班级、学生、作业和题目数据，并获得讲评或针对性练习建议。
