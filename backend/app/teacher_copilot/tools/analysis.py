...
from app.teacher_copilot.errors import QuestionNotFound, TcError
...
async def get_homework_analysis(
    homework_id: str, class_id: str, sections: list[str] | None = None,
) -> dict:
...
async def get_question_analysis(
    homework_id: str, class_id: str, question_id: str,
) -> dict:
