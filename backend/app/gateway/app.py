...
# Teacher Copilot 业务 API(就地扩展,见 T004)
from app.teacher_copilot.api.router import router as teacher_copilot_router
...
This gateway provides runtime endpoints for agent runs plus custom endpoints for models, MCP configuration, skills, and artifacts.
    ...
    app.include_router(teacher_copilot_router)
